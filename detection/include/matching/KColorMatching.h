...
#ifndef SRC_DEXTERITY_DETECTION_INCLUDE_MATCHING_KCOLORMATCHING_H_
#define SRC_DEXTERITY_DETECTION_INCLUDE_MATCHING_KCOLORMATCHING_H_
...
class KColorMatching : public Matching
{
	public:
		KColorMatching();
