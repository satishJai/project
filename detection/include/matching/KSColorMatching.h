...
#ifndef SRC_DEXTERITY_DETECTION_INCLUDE_MATCHING_KSCOLORMATCHING_H_
#define SRC_DEXTERITY_DETECTION_INCLUDE_MATCHING_KSCOLORMATCHING_H_
...
class KSColorMatching : public Matching
{
	public:
		KSColorMatching();
...
#endif /* SRC_DEXTERITY_DETECTION_INCLUDE_MATCHING_KCOLORMATCHING_H_ */
